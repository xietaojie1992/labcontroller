...
public class NodeFactory {
    ...
    public static NodeBuilder createNode(String dpid) {
        return new NodeBuilder().setId(new NodeId(dpid)).withKey(new NodeKey(new NodeId(dpid)));
    }
    ...
    public static NodeRef createNodeRef(NodeBuilder nodeBuilder) {
        return new NodeRef(InstanceIdentifier.create(Nodes.class).child(Node.class, nodeBuilder.key()));
    }
