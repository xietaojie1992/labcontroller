...
import org.opendaylight.yang.gen.v1.ns.yang.labcontroller.lab.action.mdsal.ext.rev180421.add.flow.input.instructions.instruction.instruction.apply.actions._case.apply.actions.action.action.TestActionMovementRpcAddFlowApplyActionsCaseBuilder;
...
public class FlowActionBuilderFactory {
    ...
    public static ActionBuilder createPushMplsAction(int order) {
        PushMplsActionBuilder pushMplsActionBuilder = new PushMplsActionBuilder().setEthernetType(ProtocolNumber.TYPE_MPLS.intValue());
        ActionBuilder actionMplsBuilder = new ActionBuilder().withKey(new ActionKey(order)).setOrder(order);
    ...
    public static ActionBuilder createSetMplsLabelAction(Long label, int order) {
        ...
        ActionBuilder actionFieldBuilder = new ActionBuilder().withKey(new ActionKey(order)).setOrder(order);
    ...
    public static ActionBuilder createSetDLDstAction(String macAddress, int order) {
        ...
        ActionBuilder actionDlDstBuilder = new ActionBuilder().withKey(new ActionKey(order)).setOrder(order);
    ...
    public static ActionBuilder createSetSrcIpAction(String ipAddress, int order) {
        ...
        ActionBuilder actionBuilder = new ActionBuilder().withKey(new ActionKey(order)).setOrder(order);
    ...
    public static ActionBuilder createOutputAction(String output, int order) {
        ...
        ActionBuilder actionOutputBuilder = new ActionBuilder().withKey(new ActionKey(order)).setOrder(order);
    ...
    public static ActionBuilder createDropAction(int order) {
        ...
        ActionBuilder actionDropputBuilder = new ActionBuilder().withKey(new ActionKey(order)).setOrder(order);
    ...
    public static ActionBuilder createTunnelAction(BigInteger tunnelId, int order) {
        ...
        ActionBuilder actionTunnelBuilder = new ActionBuilder().withKey(new ActionKey(order)).setOrder(order);
    ...
    public static ActionBuilder createResubmitAction(int order) {
        ...
        ActionBuilder actionResubmitBuilder = new ActionBuilder().withKey(new ActionKey(order)).setOrder(order);
    ...
    public static ActionBuilder createTestActionMovementAction(Integer movement, int order) {
        ...
        return new ActionBuilder().setAction(caseBuilder.build()).setOrder(order).withKey(new ActionKey(order));
    }
}
