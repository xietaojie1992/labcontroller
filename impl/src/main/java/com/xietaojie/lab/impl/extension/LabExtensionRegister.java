...
import com.xietaojie.lab.impl.extension.action.ActionMovementCodec;
import com.xietaojie.lab.impl.extension.action.ActionMovementConverter;
import com.xietaojie.lab.impl.extension.experimeter.TlvExperimenterCodec;
import com.xietaojie.lab.impl.extension.experimeter.TlvExperimenterConverter;
import com.xietaojie.lab.impl.extension.match.MatchConditionCodec;
import com.xietaojie.lab.impl.extension.match.MatchConditionConverter;
...
public class LabExtensionRegister {
    ...
    private ObjectRegistration<?> registerActionToOFJava(final Class<? extends Action> actionCaseType,
                                                         final ConvertorActionToOFJava<Action, org.opendaylight.yang.gen.v1.urn
                                                                 .opendaylight.openflow.common.action.rev150203.actions.grouping.Action>
                                                                 actionConverter) {
    ...
    private ObjectRegistration<?> registerActionFromOFJave(NiciraActionSerializerKey niciraActionSerializerKey,
                                                           ConvertorActionFromOFJava<org.opendaylight.yang.gen.v1.urn.opendaylight
                                                                   .openflow.common.action.rev150203.actions.grouping.Action, ActionPath>
                                                                   actionConverter) {
    ...
    private ObjectRegistration<?> registerMessageToOFJava(final Class<? extends ExperimenterMessageOfChoice> actionCaseType,
                                                          final ConvertorMessageToOFJava actionConvertor) {
