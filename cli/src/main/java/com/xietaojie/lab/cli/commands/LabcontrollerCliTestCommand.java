 ...
 */
package com.xietaojie.lab.cli.commands;
...
public class LabcontrollerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(LabcontrollerCliTestCommand.class);
    protected final LabcontrollerCliCommands service;

    public LabcontrollerCliTestCommand(final LabcontrollerCliCommands service) {
